...
**RESPUESTA:**
Python3 tiene una sintaxis más sencilla, fue el que menos lineas de codigo llevo hacer y resume todo la informacion con nombres cortos y faciles de recordar, sin mebargo, ese mismo hecho de resumir la información tanto puede volver confuso el ver pequeños nombres y lineas de codigo muy juntas. Conisdero que scala es un idiomabastante eficiente, ya que, puede ser un termino medio entre Java y Phyton, volviendolo un poco más facil de comprender al momento de leerlo, ya que, muchos de los nombres que usa no son ni muy cortos ni muy largos.
...
"Perfecto, Pablo. Mismo resultado, cero bucles mutables. Aqui tienes versiones “funcionales” puras y, de yapa, variantes seguras para evitar dividir para cero.
...
```
Listo: declarativo, sin estados mutables, y con manejo elegante del caso vacio cuando hace falta. Si quieres, lo adaptamos para Float, BigDecimal o tipos genericos."
